...
\author{
  ...
  \IEEEauthorblockA{
    ...
    Evidence ledger: \path{paper/EVIDENCE.md} (through 2026-07-21)
  }
}
...
result. Held-out tier-1 recall is not adaptive robustness. AgentDojo numbers are
banking-slice and model-specific (DeepSeek often refuses some jailbreaks).
